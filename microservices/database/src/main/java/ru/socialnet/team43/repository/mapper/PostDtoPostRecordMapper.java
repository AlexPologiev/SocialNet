...
public interface PostDtoPostRecordMapper {
    ...
    @Mapping(source = "postDto", target = "publishDate", qualifiedByName = "setTimeChangedAndPublishDate")
    @Mapping(source = "postDto", target = "timeChanged", qualifiedByName = "setTimeChangedAndPublishDate")
    ...
    @Named("setTimeChangedAndPublishDate")
    default OffsetDateTime setTimeChangedAndPublishDate(PostDto postDto) {
